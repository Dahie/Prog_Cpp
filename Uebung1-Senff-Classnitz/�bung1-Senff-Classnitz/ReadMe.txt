========================================================================
    ANWENDUNG: Übung1-Senff-Classnitz-Projektübersicht
========================================================================

Diese Übung1-Senff-Classnitz-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.  

Diese Datei enthält eine Zusammenfassung dessen, was Sie in jeder der Dateien
finden, aus denen Ihre Übung1-Senff-Classnitz-Anwendung besteht.

Übung1-Senff-Classnitz.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Übung1-Senff-Classnitz.pch und eine 
