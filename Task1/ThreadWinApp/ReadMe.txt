========================================================================
    ANWENDUNG: ThreadWinApp-Projektübersicht
========================================================================

Diese ThreadWinApp-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.  

Diese Datei enthält eine Zusammenfassung dessen, was Sie in jeder der Dateien
finden, aus denen Ihre ThreadWinApp-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "ThreadWinApp.pch und eine 
